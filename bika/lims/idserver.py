...
def generateUniqueId(context, parent=False):
    ...
    if context.portal_type not in config_map.keys():
        ...
        print 'ID Server: %s : %s' % (context.portal_type, new_id)
    ...
    config = config_map[context.portal_type]
    if context.portal_type == "AnalysisRequest":
        ...
        config = config_map['SamplePartition']
        variables_map = {
